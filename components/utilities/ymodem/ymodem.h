...
/* how many time wait for chars between packet. */
#ifndef RYM_WAIT_CHR_TMS
#define RYM_WAIT_CHR_TMS    50
#endif
/* how many time wait for between packet. */
#ifndef RYM_WAIT_PKG_TMS
#define RYM_WAIT_PKG_TMS    50
#endif
/* how many time(ms) between two handshake code. */
#ifndef RYM_CHD_INTV_TMS
#define RYM_CHD_INTV_TMS    1000
#endif
